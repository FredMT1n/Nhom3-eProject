...
const ProductDetails = ({ match }) => {
    ...
    useEffect(() => {
        ...
        if (success) {
            alert.success('Evaluation of success')
                ...
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <span id="no_of_reviews">({product.numOfReviews} Evaluate)</span>
                            ...
                            <p>Goods condition: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'} >{product.stock > 0 ? 'Còn hàng' : 'Hết hàng'}</span></p>

                            <hr />

                            <h4 className="mt-2">Describe:</h4>
                            <p>{product.description}</p>
                            <hr />
                            <p id="product_seller mb-3">Origin: <strong>{product.seller}</strong></p>

                            {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                                Product comments
                            </button>
                                :
                                <div className="alert alert-danger mt-5" type='alert'>You need to log in to rate this product.</div>
                            }
                                        ...
                                        <div className="modal-dialog" role="document">
                                            <div className="modal-content">
                                                <div className="modal-header">
                                                    <h5 className="modal-title" id="ratingModalLabel">Product reviews</h5>
